...
class ExamsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create exam" do
    assert_difference('Exam.count') do
      post exams_url, params: { exam: { Schedule_id: @exam.Schedule_id, User_id: @exam.User_id, end: @exam.end, start: @exam.start } }
    end
  ...
  test "should update exam" do
    patch exam_url(@exam), params: { exam: { Schedule_id: @exam.Schedule_id, User_id: @exam.User_id, end: @exam.end, start: @exam.start } }
